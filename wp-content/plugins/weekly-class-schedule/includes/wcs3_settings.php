    ...
    if ( isset( $_POST['wcs3_options_nonce'] ) ) {
        ...
        if ($valid === FALSE) {
        	...
        	$fields = array(
        	    ...
        	    'open_template_links_in_new_tab' => 'wcs3_validate_yes_no',
        ...
        <table class="form-table">
            ...
            <tr>
                <th>
                    ...
                    <br/>
                    <div class="wcs3-description"><strong><?php _e( 'Available placeholders:', 'wcs3'); ?></strong> [class], [instructor], [location], [start hour], [end hour], [notes].
                    <br/><br/>
                    <strong>Link placeholders:</strong> [class_link], [instructor_link], [location_link]
                    </div>
                </th>
                <td>
            ...
            <tr>
                <th>
                    <?php _e( 'Open template links in new tabs', 'wcs3' ); ?>
                    <div class="wcs3-description"><?php _e( 'Enabling this will open the template links (e.g. [class_link]) in a new tab.', 'wcs3' ); ?></div>
                </th>
                <td><?php wcs3_bool_checkbox( 'wcs3_open_template_links_in_new_tab', $wcs3_options['open_template_links_in_new_tab'], __('Yes') ); ?></td>
            </tr>
...
function wcs3_set_default_settings() {
    ...
    if ( $settings === FALSE ) {
        ...
        $options = array(
            ...
            'open_template_links_in_new_tab' => 'yes',
