...
if (!function_exists('gdr2_readfile')) {
     ...
     */
    function gdr2_readfile($file_path, $part_size = 2, $return_size = true) {
...
if (!function_exists('gdr2_download_simple')) {
    /**
     ...
     * @param bool $gdr_readfile use gdr2 own readfile function
     */
    function gdr2_download_simple($file_path, $args = array(), $gdr_readfile = true) {
...
if (!function_exists('gdr2_download_resume')) {
    /**
     ...
     */
    function gdr2_download_resume($file_path, $args = array()) {
