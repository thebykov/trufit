...
if ( ! file_exists( $wpsu_css->tmp_dir ) ): ?>
                <div class="updated settings-error" id="setting-error-settings_updated">
                    <p><strong><?php echo __( 'Temporary directory does not exist. You will need to manually create this directory by using the commands below. After running the commands, be sure to update your settings and select the "Save Changes" button below.</strong> <ul><li>mkdir ' . $wpsu_css->tmp_dir . ';</li><li>chmod 777 ' . $wpsu_css->tmp_dir . ';', $wpsu_css->nspace ); ?></li></ul></strong></p>
                    <p><strong><?php echo __( 'Alternatively, you may use your FTP client to create a directory called "tmp" directly in the this plugin directory rather than running the commands above.', $wpsu_css->nspace ); ?></strong></p>
                </div>
<?php elseif( ! is_writable( $wpsu_css->tmp_dir ) ): ?>
                <div class="updated settings-error" id="setting-error-settings_updated"><p><strong><?php echo __( 'Temporary directory is not writable. You will need to manually fix permissions by using this command (or use your FTP client to give 777 permissions to the tmp directory):</strong> <ul><li>chmod 777 ' . $wpsu_css->tmp_dir . ';', $wpsu_css->nspace ); ?></li></ul></p></div>
<?php elseif ( ! file_exists( $wpsu_css->css_settings_path ) ): ?>
                <div class="updated settings-error" id="setting-error-settings_updated">
                    <p><strong><?php echo __( 'Settings file does not exist. Select the "Save Changes" button below to generate this file. If the file does not exist after selecting the "Save Changes" button, you will need to manually create this file by using these commands (or using your FTP client to create the file):</strong> <ul><li>touch ' . $wpsu_css->css_settings_path . ';</li><li>chmod 666 ' . $wpsu_css->css_settings_path . ';', $wpsu_css->nspace ); ?></li></ul></p>
                </div>
<?php elseif( ! is_writable( $wpsu_css->css_settings_path ) ): ?>
                <div class="updated settings-error" id="setting-error-settings_updated"><p><strong><?php echo __( 'Settings file is not writable. You will need to manually fix permissions by using this command:</strong> <ul><li>chmod 666 ' . $wpsu_css->css_settings_path . ';', $wpsu_css->nspace ); ?></li></ul></p></div>
<?php endif; ?>
                <form method="post">
