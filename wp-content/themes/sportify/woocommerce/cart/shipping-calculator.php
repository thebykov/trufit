	...
	<div class="cart_shipping cart-block">
	<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

		<h2 class="entry-header"><a href="#" class="shipping-calculator-button entry-title"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></h2>
