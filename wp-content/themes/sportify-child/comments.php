	...
	<?php if ( post_password_required() ) : ?>
		...
		$args = array(
			'fields' => apply_filters( 'comment_form_default_fields', array(
				'author' => '<div class="row"><div class="col-md-6"><label for="author">'._x('Name','comment-form','sportify').'</label><input class="comments-line comments-line-1" id="author" name="author" type="text" placeholder="Enter your name" value="' . esc_attr( $commenter[ 'comment_author' ] ) . '" aria-required="true"></div>',
				'email' => '<div class="col-md-6"><label for="e-mail">'._x('E-Mail','comment-form','sportify').'</label><input class="comments-line comments-line-2" name="email" id="e-mail" type="text" placeholder="Enter your e-mail adress" value="' . esc_attr( $commenter[ 'comment_author_email' ] ) . '" aria-required="true"></div></div>'
				)
			),
			'comment_notes_after' => '',
