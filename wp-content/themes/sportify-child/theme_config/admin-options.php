                ...
                array(
                        ...
                        'boxes' => array(
                                'Logo Customization' => array(
                                        ...
                                        'input_fields' => array(
                                                'Desktop Logo As Image'=>array(
                                                        'size'=>'half',
                                                        'id'=>'desktop_logo_image',
                                                        'type'=>'image_upload',
                                                        'note'=>'Here you can insert your link to a desktop image logo or upload a new logo image.'
                                                ),
												'Mobile Logo As Image'=>array(
                                                        'size'=>'half',
                                                        'id'=>'mobile_logo_image',
                                                        'type'=>'image_upload',
                                                        'note'=>'Here you can insert your link to a mobile image logo or upload a new logo image.'
                                                ),
                                                'Logo As Text'=>array(
                                                        'size'=>'half_last',
                                                        'id'=>'logo_text',
                                ...
                                'Social Platforms'=>array(
                                        ...
                                        'input_fields'=>array(
                                                array(
                                                        ...
                                                        'platforms'=>array('facebook','twitter', 'pinterest', 'dribbble', 'youtube', 'instagram', 'googleplus', 'linkedin','behance')
                                                )
                                        )
                                ),
                                'Tracking Code' => array(
