    ...
    <article class="blog-item list-slyle">
        ...
        <div class="grey-background">
            ...
            <header class="blog-head">
                ...
                <h4 class="entry-header text-center padding"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4><div class="tags-list post-tags-list"><?php the_terms( $post->ID, 'wod_tags', '', ', ', ' ' ); ?></div>
