...
<head>
    ...
    <!-- Bootstrap -->
    <link href="<?php get_template_directory() ?>/bent/css/bootstrap.min.css" rel="stylesheet">

    <!-- Owl Carousel Assets -->
    <link href="<?php get_template_directory() ?>/bent/css/owl.carousel.css" rel="stylesheet">
    <link href="<?php get_template_directory() ?>/bent/css/owl.theme.css" rel="stylesheet">


    <!-- Pixeden Icon Font -->
    <link rel="stylesheet" href="<?php get_template_directory() ?>/bent/css/Pe-icon-7-stroke.css">

    <!-- Font Awesome -->
    <link href="<?php get_template_directory() ?>/bent/css/font-awesome.min.css" rel="stylesheet">


    <!-- PrettyPhoto -->
    <link href="<?php get_template_directory() ?>/bent/css/prettyPhoto.css" rel="stylesheet">
    
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="favicon.ico" />

    <!-- Style -->
    <link href="<?php get_template_directory() ?>/bent/css/style.css" rel="stylesheet">

    <link href="<?php get_template_directory() ?>/bent/css/animate.css" rel="stylesheet">
    <!-- Responsive CSS -->
    <link href="<?php get_template_directory() ?>/bent/css/responsive.css" rel="stylesheet">
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">
                            <img src="<?php get_template_directory() ?>/bent/images/logo.png" alt="Logo">
                        </a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo text-center">
                                <!-- LOGO -->
                            <img width="125" height="55" src="<?php get_template_directory() ?>/bent/images/logo.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-3 col-md-offset-1 col-sm-4">
                        <div class="home-iphone">
                            <img src="<?php get_template_directory() ?>/bent/images/iPhone_Home.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <!-- PHONE -->
                            <img src="<?php get_template_directory() ?>/bent/images/about_iphone.png" alt="">
                        </div>
                    </div>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <!-- IMAGE -->
                                                <img src="<?php get_template_directory() ?>/bent/images/client_1.png" alt="">
                                ...
                                <div class="item">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                 <!-- IMAGE -->
                                                <img src="<?php get_template_directory() ?>/bent/images/client_2.png" alt="">
                                                <div class="testimonial_caption">
                                                <!-- DESCRIPTION --> 
                                ...
                                <div class="item">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <!-- IMAGE -->
                                                <img src="<?php get_template_directory() ?>/bent/images/client_3.png" alt="">
                                                <div class="testimonial_caption">
                                                <!-- DESCRIPTION --> 
                                                    <h2>Joel Mchale</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="feature_iphone">
                            <!-- FEATURE PHONE IMAGE -->
                            <img class="wow bounceIn" data-wow-duration="1s" src="<?php get_template_directory() ?>/bent/images/iPhone02.png" alt="">
                        </div>
                    </div>
        ...
        <div class="screen_slider">
            <div id="demo" class="wow bounceInRight" data-wow-duration="1s">
                <div id="owl-demo" class="owl-carousel">
                    ...
                    <!-- APPS SCREEN IMAGES -->
                    <div class="item">
                    <a href="images/screens/iPhone04.png" rel="prettyPhoto[pp_gal]"><img src="<?php get_template_directory() ?>/bent/images/iPhone04.png" width="60" height="60" alt="APPS SCREEN" /></a>
                    </div>
                    <div class="item">
                        <a href="images/screens/iPhone05.png" rel="prettyPhoto[pp_gal]"><img src="<?php get_template_directory() ?>/bent/images/iPhone05.png" width="60" height="60" alt="APPS SCREEN" /></a>
                    </div>
                    <div class="item">
                        <a href="images/screens/iPhone06.png" rel="prettyPhoto[pp_gal]"><img src="<?php get_template_directory() ?>/bent/images/iPhone06.png" width="60" height="60" alt="APPS SCREEN" /></a>
                    </div>
                    <div class="item">
                        <a href="images/screens/iPhone07.png" rel="prettyPhoto[pp_gal]"><img src="<?php get_template_directory() ?>/bent/images/iPhone07.png" width="60" height="60" alt="APPS SCREEN" /></a>
                    </div>
                    <div class="item">
                        <a href="images/screens/iPhone08.png" rel="prettyPhoto[pp_gal]"><img src="<?php get_template_directory() ?>/bent/images/iPhone08.png" width="60" height="60" alt="APPS SCREEN" /></a>
                    </div>
                    <div class="item">
                        <a href="images/screens/iPhone09.png" rel="prettyPhoto[pp_gal]"><img src="<?php get_template_directory() ?>/bent/images/iPhone09.png" width="60" height="60" alt="APPS SCREEN" /></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="download_screen text-center wow fadeInUp" data-wow-duration="1s">
                        <img src="<?php get_template_directory() ?>/bent/images/download_screen.png" alt="">
                    </div>
                </div>
            </div>
        </div>
...
============================== -->
    ...
    <script src="<?php get_template_directory() ?>/bent/js/jquery.min.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/bootstrap.min.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/owl.carousel.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/jquery.fitvids.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/smoothscroll.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/jquery.parallax-1.1.3.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/jquery.prettyPhoto.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/jquery.ajaxchimp.min.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/jquery.ajaxchimp.langs.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/wow.min.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/waypoints.min.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/jquery.counterup.min.js"></script>
    <script src="<?php get_template_directory() ?>/bent/js/script.js"></script>
